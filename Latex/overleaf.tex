...
Tiempo total de apertura del estacionamiento  & 43200 s (12 horas)                      \\ \hline
Tiempo total de simulación     & 58000 s (debe ser mayor a 12 horas)                    \\ \hline
\end{tabular}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Debe ser mayor al tiempo máximo del estacionamiento para que los autos puedan retirarse correctamente y no romper la propiedad de Liveness.
        \item Tiempo máximo de apertura del estacionamiento: \\
        Se configura en los parámetros del sensor de entrada.
        Debe ser menor al tiempo máximo de simulación para que los autos puedan entrar y retirarse correctamente y no romper la propiedad de Liveness.
    \end{itemize}
...
\textbf{Conclusión del Experimento 5:} Al aumentar el doble el tiempo de rendimiento de las barreras(más lentas), la ocupación promedio descendió a 14–16 vehículos y los tiempos de permanencia se mantuvieron entre 250 y 300. No se produjeron rechazos, ya que la lentitud de las barreras limitó el número de ingresos.
...
\textbf{Conclusión del Experimento 6:} Con las barreras al doble de velocidad, es decir, mejor rendimiento, menor tiempo de demora y las demás condiciones iguales, la ocupación promedio osciló entre 20 y 25 vehículos y los tiempos de permanencia entre 200 y 250; sin embargo, se observaron picos ascendentes en la tasa de rechazo, que alcanzó valores próximos a 0,012, debido a la saturación cuando un vehículo llegaba con el estacionamiento lleno.
...
Los escenarios planteados son muy similares en cuanto a gráficos y rendimiento, entonces para ilustrar un caso proponemos ver el escenario uno en: \hyperlink{exp1}{"\ Experimento 1 "\ }, y si se desea ver el resto, se puede modificar los parametros en el modelo y ver los resultados arrojados por el monitor.
...
\hline
\textbf{Escenario} & \textbf{Generador} & \textbf{Barreras} & \textbf{Estacionamiento} \\
\hline
1 & 3  & 29 & 40 \\
2 & 4  & 17 & 30 \\
3 & 22 & 29 & 40 \\
...
\hline
\end{tabular}
\caption{Escenarios. Cada combinación de valores en Generador, Barreras y Estacionamiento corresponde a una configuración distinta de semillas aleatorias, utilizadas para introducir variabilidad controlada en las simulaciones.}
\end{table}
...
\begin{tabular}{|l|c|c|}
\hline
\textbf{Métrica} & \textbf{Media} & \textbf{Desvío estándar} \\
\hline
Permanencia & 278.305 & 4.389 \\
Ocupación   & 25.108  & 0.384 \\
Rechazo     & 0.000   & 0.000 \\
\hline
\end{tabular}
\caption{Media y desvío estándar de las métricas obtenidas en los 10 escenarios}
\end{table}
...
\[
\bar{X} = 0{,}0000,\quad S = 0{,}0000
\]

\[
IC_{95\%} = 0{.}0000 \pm 2{.}2622 \cdot \frac{0{.}0000}{\sqrt{10}} = 0{.}0000
\]

\[
\Rightarrow \boxed{[0{.}0000,\ 0{.}0000]}
\]
\vspace{0.2cm}
\hline
...
\[
\bar{X} = 278{,}305,\quad S = 4{,}389
\]

\[
IC_{95\%} = 278{.}305 \pm 2{.}2622 \cdot \frac{4{.}389}{\sqrt{10}} \approx 278{.}305 \pm 3{.}139
\]

\[
\Rightarrow \boxed{[275{.}166,\ 281{.}444]}
\]
\vspace{0.2cm}
\hline
...
\[
\bar{X} = 25{.}108,\quad S = 0{.}384
\]

\[
IC_{95\%} = 25{.}108 \pm 2{.}2622 \cdot \frac{0{.}384}{\sqrt{10}} \approx 25{.}108 \pm 0{.}275
\]

\[
\Rightarrow \boxed{[24{.}833,\ 25{.}383]}
\]
\vspace{0.2cm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{IC-semillas.png}
\caption{\small
...
\textit{Nota: el intervalo de confianza para la tasa de rechazo es nulo, ya que en todos los experimentos fue 0.}
}
...
A partir del análisis de los intervalos de confianza al 95\,\%, se observa que la \textbf{Tasa de Rechazo} fue nula en todos los escenarios, la excelente capacidad del sistema para admitir vehículos parte de la condición de que no haya colas prolongadas en el sensor de ingreso. En situaciones reales, si se acumulan vehículos esperando autorización podria generarse una demora significativa en el acceso aunque la experiencia interna sea fluída. El \textbf{Tiempo de Permanencia} presenta una media de aproximadamente 278 segundos, con un intervalo entre 275 y 281 segundos, lo cual indica una duración estable y controlada de los vehículos dentro del sistema. Por su parte, la \textbf{Ocupación Promedio} se encuentra entre 24.83 y 25.38 vehículos, evidenciando un uso intensivo y constante del espacio disponible. Estos resultados reflejan un sistema bien dimensionado en términos de capacidad y eficiencia, sin pérdidas por saturación durante las condiciones analizadas.

\clearpage
\section{Análisis de Propiedades}
\subsection{Safety}
Esta propiedad debe mostrar que en todo experimento realizado la ocupación máxima nunca supera la capacidad máxima del estacionamiento.

En nuestro sistema, utilizando una capacidad máxima de 30, los experimentos van a cumplir siempre con esta propiedad porque el controlador revisa en las peticiones de entrada al estacionamiento si la cantidad de autos actual en el estacionamiento es menor a 30 o igual a 30.
...
Basándonos en el experimento 1, que es la implementación base del sistema simulado, los resultados obtenidos denotan un sistema bastante estable, porque se mantiene una ocupación alta y sin rechazos.
